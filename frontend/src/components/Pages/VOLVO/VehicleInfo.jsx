...
const apiCatalog = [
  {
    ...
    desc: "Product (vehicle) information(Unsuccessful) "
  },
  {
    title: "Reading Information",
    desc: "Detailed reading information(Unsuccessful)."
  },
  {
    title: "Parameters metadata ",
    desc: "Metadata information for parameters(Unsuccessful)."
  },
  {
    title: "Parameters Unsuccessful",
...
const VehicleInfo = () => {
  ...
  return (
    <div style={styles.container}>
      {/* Animated Heading */}
      <h1 className="animated-heading">Basic Vehicle Information</h1>
