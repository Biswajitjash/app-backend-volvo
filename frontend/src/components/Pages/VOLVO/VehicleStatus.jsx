  ...
  const collectionsConfig = {
    "1 Vehicles Position": {
      ...
      params: [
        ...
        { key: "vin", value: "" } ,
        { key: "contentFilter", value: "" } ,
        { key: "additionalContent", value: "" } ,
  ...
  const sendRequest = async () => {
    ...
    try {
      while (hasMore) {
        ...
        const vehicles = data?.vehicleStatusResponse?.vehicleStatuses || [];
        const moreDataAvailable = data?.vehicleStatusResponse?.moreDataAvailable;
